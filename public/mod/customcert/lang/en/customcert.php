...
$string['includeinnotvisiblecourses'] = 'Include certificates in hidden courses or categories';
$string['includeinnotvisiblecourses_desc'] = 'Certificates from hidden courses, or from courses in a hidden category, are not processed by default. If you want to include them, enable this setting.';
