...
/**
 * Certificate template element created event.
 *
...
class element_created extends base {
    ...
    public static function get_name(): string {
        return get_string('eventelementcreated', 'customcert');
    }
     ...
     */
    public static function create_from_element(element_interface $element): element_created {
