...
final class upgrade_visuals_migration_test extends advanced_testcase {
    ...
    public static function element_scalar_key_provider(): array {
        return [
            ...
            'text scalar maps to text key' => [
                'This is text 15', 'text', 15, 'timesbi', 15, '#2D4EFA',
                ['text' => 'This is text 15', 'width' => 15, 'font' => 'timesbi', 'fontsize' => 15, 'colour' => '#2D4EFA'],
            ],
            'coursename scalar maps to coursenamedisplay key' => [
                '1', 'coursename', 15, 'zapfdingbats', 15, '#04D236',
                ['coursenamedisplay' => 1, 'width' => 15, 'font' => 'zapfdingbats', 'fontsize' => 15, 'colour' => '#04D236'],
            ],
