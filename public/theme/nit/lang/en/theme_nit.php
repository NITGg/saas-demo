...
$string['edit_sidehint'] = 'Select a section to edit its text, images and links. Changes preview live; Save to publish.';
...
$string['edit_navlinkshint'] = 'Pages shown in the top navigation (Moodle custom menu).';
$string['edit_footerlinks'] = 'Footer links';
$string['edit_footerlinkshint'] = 'Pages listed in the footer link column. None picked = the template defaults.';
