...
if (\theme_nit\local\editor::can_edit()) {
    ...
    $niteditcfg = [
        ...
        'contact'       => [
            ...
            'facebook'  => (string) get_config('theme_nit', 'social_facebook'),
            'instagram' => (string) get_config('theme_nit', 'social_instagram'),
            'youtube'   => (string) get_config('theme_nit', 'social_youtube'),
        ...
        'str'           => [
            ...
            'c_facebook'    => get_string('edit_c_facebook', 'theme_nit'),
            'c_instagram'   => get_string('edit_c_instagram', 'theme_nit'),
            ...
            'colours'       => get_string('edit_colours', 'theme_nit'),
            'palettenote'   => get_string('edit_palettenote', 'theme_nit'),
            'col_primary'   => get_string('edit_col_primary', 'theme_nit'),
            'col_accent'    => get_string('edit_col_accent', 'theme_nit'),
            'col_secondary' => get_string('edit_col_secondary', 'theme_nit'),
            'col_background' => get_string('edit_col_background', 'theme_nit'),
            'col_surface'   => get_string('edit_col_surface', 'theme_nit'),
            ...
            'herohighlight' => get_string('edit_herohighlight', 'theme_nit'),
            'selected' => get_string('edit_selected', 'theme_nit'),
            'pickatleast' => get_string('edit_pickatleast', 'theme_nit'),
            'max' => get_string('edit_max', 'theme_nit'),
            'structurewarn' => get_string('edit_structurewarn', 'theme_nit'),
