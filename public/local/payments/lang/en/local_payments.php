...
$string['academy_slug'] = 'Academy tag (shared Kashier account)';
$string['academy_slug_desc'] = 'Short tag identifying this academy on the shared Kashier merchant account. Usually set automatically by the platform provisioner; leave blank to derive it from the site URL. Used to prefix order ids and tag payment metadata.';
$string['revenue_ingest_url'] = 'Revenue ingest URL (platform)';
$string['revenue_ingest_url_desc'] = 'nit2 endpoint that receives a copy of each completed payment for per-academy revenue reporting. Set automatically by the provisioner; leave blank to disable.';
$string['revenue_ingest_secret'] = 'Revenue ingest secret';
$string['revenue_ingest_secret_desc'] = 'Shared secret sent with each mirrored payment. Set automatically by the provisioner.';
