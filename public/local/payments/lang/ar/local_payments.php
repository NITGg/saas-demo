...
$string['academy_slug'] = 'معرّف الأكاديمية (حساب كاشير المشترك)';
$string['academy_slug_desc'] = 'معرّف قصير يميّز هذه الأكاديمية على حساب كاشير المشترك. يُضبط عادةً تلقائياً من منصة التزويد؛ اتركه فارغاً ليُشتق من رابط الموقع. يُستخدم كبادئة لأرقام الطلبات ولوسم بيانات الدفع.';
$string['revenue_ingest_url'] = 'رابط استقبال الإيرادات (المنصة)';
$string['revenue_ingest_url_desc'] = 'نقطة استقبال في nit2 تتلقى نسخة من كل عملية دفع مكتملة لتقارير إيرادات كل أكاديمية. تُضبط تلقائياً من منصة التزويد؛ اتركها فارغة للتعطيل.';
$string['revenue_ingest_secret'] = 'مفتاح استقبال الإيرادات';
$string['revenue_ingest_secret_desc'] = 'مفتاح مشترك يُرسل مع كل عملية دفع مُرحّلة. يُضبط تلقائياً من منصة التزويد.';
